...
<template>
    <div v-if="show">
        <div :class="{ 'bg-green-900': styling == 'success', 'bg-red-900': styling == 'danger' }">
            <div class="max-w-8xl mx-auto px-4 md:px-6 lg:px-8 py-2">
                <div class="flex items-center justify-between flex-wrap">
                    <div class="w-0 flex-1 flex items-center min-w-0">
                        <span class="flex p-2 rounded-lg" :class="{ 'bg-green-700': styling == 'success', 'bg-red-600': styling == 'danger' }">
                    ...
                    <div class="shrink-0 sm:ms-3">
                        <button
                            ...
                            :class="{ 'hover:bg-green-600 focus:bg-green-600': styling == 'success', 'hover:bg-red-600 focus:bg-red-600': styling == 'danger' }"
                            aria-label="Dismiss"
                            @click="closeBanner"
                        >
