...
<template>
    <div class="relative">
        <div @click="open = ! open">
            <button v-if="notifications.length == 0" class="text-gray-500 rounded-full p-2 cursor-pointer bg-transparent hover:bg-blackop-30 transition ease-in-out duration-300">
