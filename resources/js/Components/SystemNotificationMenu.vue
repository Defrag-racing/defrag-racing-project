    ...
    <div class="relative">
        <div @click="open = ! open">
            ...
            <button v-else class="rounded-full p-2 cursor-pointer bg-transparent hover:bg-blackop-30 transition ease-in-out duration-300">
                <div v-if="ping" class="noti-ping absolute w-6 h-6 rounded-full bg-red-500 z-0 animate-ping"></div>
        ...
        >
            <div v-show="open" style="width: 400px; display: none; max-width: 80vw; z-index: 2000;" class="absolute mt-2 rounded-md shadow-lg end-0" @click="open = false">
                <div class="rounded-md ring-1 ring-white ring-opacity-5 bg-gray-800 py-2 px-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center font-bold text-gray-300">
                            ...
                            <span class="ml-2">System Notifications</span>
                        </div>
    
                        <div class="flex items-center">
                            <Link :href="route('profile.show') + '#notifications-settings'" class="font-bold text-blue-300 hover:text-blue-200 cursor-pointer mr-3">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
