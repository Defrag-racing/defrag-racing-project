...
<template>
    <div>
        <ConfirmationModal :show="show" maxWidth="xl" :closeable="true" @close="close">
            ...
            <template #content>
               Are you sure you want to transfer the clan [<span class="text-gray-100" v-html="q3tohtml(clan.name)"></span>] to the player [<span class="text-gray-100" v-html="q3tohtml(player.name)"></span>] ? This action is irreversible !!!
            </template>
