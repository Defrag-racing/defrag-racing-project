...
<template>
    <div>
        ...
        <div class="py-12">
            <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-between items-center mb-5 flex-wrap">
                    ...
                    <div class="flex flex-wrap justify-center" v-if="! myClan">
                        <div @click="showInvitiationsModal = !showInvitiationsModal" class="text-gray-300 bg-grayop-700 cursor-pointer hover:bg-grayop-600 text-center rounded-lg px-3 py-2 mr-2 flex items-center mb-2">
                        ...
                        <Link :href="route('clans.manage.create')" class="text-gray-300 bg-grayop-700 cursor-pointer hover:bg-grayop-600 text-center rounded-lg px-3 py-2 mr-2 flex items-center mb-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-2">
        ...
        <InvitationsModal :show="showInvitiationsModal" :close="() => showInvitiationsModal = false" :invitations="invitations" />
    </div>
</template>
