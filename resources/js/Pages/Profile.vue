                ...
                <div class="flex justify-center">
                    <div>
                        ...
                        <div class="flex mt-3 justify-center gap-2 items-center">
                            ...
                            <div @click="copyHandle(user?.discord_name)" v-if="user?.discord_name" class="flex items-center gap-2 cursor-pointer text-xs font-medium me-2 px-2.5 py-1.5 rounded bg-indigo-900 text-indigo-300 hover:text-indigo-100">
                                ...
                                <span class="text-sm" v-if="!copyText">#{{user?.discord_name}}</span>
