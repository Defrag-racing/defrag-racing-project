        ...
        <div class="max-w-8xl mx-auto py-5 sm:px-6 lg:px-8">
            <div>
                <div class="flex justify-center">
                    <div>
                        <div class="text-xs w-16 h-16 flex flex-col items-center justify-center border-green-500 text-white rounded-full p-1 relative">
                            <span>19555</span>
                            <span>Records</span>
                    ...
                    <div>
                        <div class="flex flex-col items-center p-4 relative">
                            <img class="h-20 w-20 rounded-full border-4 border-gray-500 object-cover" :src="user.profile_photo_path ? '/storage/' + user.profile_photo_path : '/images/null.jpg'" :alt="user.name">

                            <div class="text-gray-500 absolute" style="width: 200px; top: 23%">
