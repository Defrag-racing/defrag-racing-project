    ...
    <MainLayout title="Servers">
        <template #header>
            <div class="flex justify-between items-center">
                ...
                <div class="flex">
                    <div @click="updatePage" title="Auto Update Servers every 30 seconds" class="flex items-center text-white bg-gray-700 py-2 px-4 rounded-md font-bold cursor-pointer bg-gray-700 hover:bg-gray-600 mr-3">
                    ...
                    <Dropdown align="center" width="48">
                        ...
                        <template #content>
                            <div @click="sortByPopularity" class="cursor-pointer block px-4 py-2 text-sm leading-5 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none focus:bg-gray-100 dark:focus:bg-gray-800 transition duration-150 ease-in-out">
                                Popularity
                            </div>

                            <div @click="sortByAlphabets" class="cursor-pointer block px-4 py-2 text-sm leading-5 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none focus:bg-gray-100 dark:focus:bg-gray-800 transition duration-150 ease-in-out">
                                Alphabetically
                            </div>
                        </template>
                    </Dropdown>
