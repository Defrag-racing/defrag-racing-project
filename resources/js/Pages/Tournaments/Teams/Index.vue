...
<template>
    <Tournament :tournament="tournament" tab="Teams">
        <div v-for="team in teams" class="mb-10 md:mb-4">
            <div class="grid grid-cols-1 md:grid-cols-3 mx-5 lg:mx-0">
                ...
                <div class="col-span-1 text-center mt-3 lg:mt-0 order-1 md:order-1">
                    <div class="tech-line-base mb-4"></div>
                    <div class="text-2xl text-white" v-html="q3tohtml(team.name)"></div>
                </div>
...
<style scoped>
    ...
    .tech-line-base {
        ...
        box-shadow: 0 0 50px 4px #c5c5c56f;
        height: 1px;
        margin-top: 5px;
        max-width: 100%;
    }
    ...
    .ruler {
        height: 1px;
        width: 100%;
        background: linear-gradient(90deg,#5a5a5a42,#686868,#5a5a5a42);
    }
</style>